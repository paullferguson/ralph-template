...
7. Once you have a complete understanding of the problem and solution, use the template below to write the PRD. Save the PRD as a markdown file in the `/plans` directory (e.g., `/plans/prd.md`).
